...
namespace TgBot.Migrations.TgBot
{
    ...
    [Migration("20200405234332_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TgBot.DTO.Chat", b =>
                {
                    b.Property<long>("Id")
            ...
            modelBuilder.Entity("TgBot.DTO.ListenerState", b =>
                {
            ...
            modelBuilder.Entity("TgBot.DTO.MessageEntry", b =>
                {
                    b.Property<long>("ChatId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("TgBot.DTO.PolicySettings", b =>
                {
                    b.Property<long>("ChatId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("TgBot.DTO.RulesMessage", b =>
                {
                    b.Property<long>("ChatId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("TgBot.DTO.User", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("TgBot.DTO.UserWarnings", b =>
                {
                    b.Property<long>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
